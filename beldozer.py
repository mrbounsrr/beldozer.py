...
class InstagramBot:
	...
	def __init__(self, username, password):
		self.username = 'put your name here'	# IG Username
		self.password = 'put your password here '	# IG Password
...
insta = InstagramBot('put your name here ', 'put your password here ')
insta.login()
insta.findMyFollowers(4)
insta.followTheirFollowers(67)
